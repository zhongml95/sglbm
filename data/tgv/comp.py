...
SGdataU = np.loadtxt("./t5/Nr4Nq9N32/final/u.dat")

SGdataU[:,0] = SGdataU[:,0] / (2 * math.pi)
...
plt.plot(mcDataU1E3[:,0], mcDataU1E3[:,1], label="MCS(OpenLB, 1E3)", linewidth = 2, color=colors[1], linestyle='-')
plt.plot(mcDataU1E4[:,0], mcDataU1E4[:,1], label="MCS(OpenLB, 1E4)", linewidth = 2, color=colors[2], linestyle='-')
plt.plot(mcDataU1E5[:,0], mcDataU1E5[:,1], label="MCS(OpenLB, 1E5)", linewidth = 2, color=colors[3], linestyle='-')
plt.plot(SGdataU[:,0], SGdataU[:,1], label="SG LBM", linewidth = 3, color=colors[0],linestyle='--')
...
plt.plot(SGdataU[:,0], SGdataU[:,2], label="SG LBM", linewidth = 2, color=colors[0],linestyle='--')
plt.rcParams.update({'font.size': 12})
# Setting x-axis as log scale
plt.legend(fontsize = 'large')
plt.ticklabel_format(style='sci', axis='y', scilimits=(0,0))
